...
### 2.3.1 Data Augmentation
  ...
  - Second form of data augmentation **(Fancy PCA image augmentation)**:
    ...
    Where $$I_{xy}$$ is image pixel, $$p_{i}$$ and $$\lamda_{i}$$ are eigenvector and eigenvalue of the covriance matrix (3*3) of the RGB value list of training images set. Moreover, $$\alpha$$ is random variable drawn from distribution which has mean zero and standar deviation 0.1
